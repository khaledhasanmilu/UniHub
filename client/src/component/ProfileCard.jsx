  ...
  const fetchProfileData = async () => {
    try {
      const response = await axios.get(
        `http://localhost:5000/api/user/details/${id}`,
        {
...
const handleMessenger = async () => {
  ...
  return (
    <div>
      <div className="max-w-4xl mx-auto bg-white shadow-sm rounded-lg overflow-hidden border border-gray-200 p-6 flex items-center">
        <div className="">
          <img
          ...
          {currentUserId === id && (
            <button
              className="bottom-2 right-2 bg-gray-800 text-white p-2 rounded-full"
        ...
        <div className="ml-6 flex-1">
          ...
          <div className="mt-4 flex space-x-4">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-800 hover:underline flex items-center space-x-1"
            >
        ...
        <div className="ml-6 flex flex-col items-center justify-evenly gap-2 h-full">
            {currentUserId === id && (
                <button
                onClick={handleEditClick}
                className="px-4 py-2 mb-5 rounded-full flex items-center space-x-2"
                >
                <FaEdit />
                <span>Edit</span>
                </button>
         ...
         {currentUserId !== id && (
             ...
             className={`px-4 py-2 rounded-full text-white flex items-center space-x-2 transition ${
               isFollowing
          ...
          <p className="mt-2 text-gray-600 flex items-center space-x-2">
            <FaUsers /> <span>Following: {following}</span>
          </p>
        </div>
